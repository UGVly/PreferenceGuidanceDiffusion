...
def parse_args():
    ...
    parser.add_argument("--sft_mode", type=str, default="win", choices=["win", "lose"], help="Mode for SFT")
        ...
        def preprocess_train(examples):
            if 'pickapic' in args.dataset_name:
                ...
                for im_0_bytes, im_1_bytes, label_0 in zip(examples['jpg_0'], examples['jpg_1'], examples['label_0']):
                    ...
                    if args.sft_mode == "win":
                        im_bytes = im_0_bytes if label_0==1 else im_1_bytes
                    elif args.sft_mode == "lose":
                        im_bytes = im_0_bytes if label_0==0 else im_1_bytes
                    else:
                        assert False, "Invalid SFT mode for cPGD learning."
